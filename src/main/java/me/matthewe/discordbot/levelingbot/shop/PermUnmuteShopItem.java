 ...
 */
public class PermUnmuteShopItem extends ShopItem {
    public PermUnmuteShopItem(ShopItems item, long userId, long purchaseDate) {
        super(item, userId, purchaseDate);
    }
    public PermUnmuteShopItem(ShopItems item) {
        super(item);
    }
    @Override
