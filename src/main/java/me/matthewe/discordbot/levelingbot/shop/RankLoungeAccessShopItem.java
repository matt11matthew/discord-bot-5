 ...
 */
public class RankLoungeAccessShopItem extends ShopItem {
    public RankLoungeAccessShopItem(ShopItems item, long userId, long purchaseDate) {
        super(item, userId, purchaseDate);
    }
    public RankLoungeAccessShopItem(ShopItems item) {
        super(item);
    }
    @Override
